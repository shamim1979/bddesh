...
class NewspapersController {
	...
	def newsSource() {
		...
		if(newsSource){
			...
			def keyWords = "bddesh24, newspapers,"
			if(newsSource.title){
			...
			metaData.put("image", "http://www.bddesh24.com/images/bddeshdefault/defaultLinkz.jpg")
			metaData.put("url", "http://www.bddesh24.com/newspapers/newsSource/"+newsSource.id+"/"+seoCovert(title:newsSource.title)+"-newspaper")
	...
	def newsSourceList() {
		...
		if(newsSourceItem){
			...
			if(newsSourceItem.shortDescription)
				...
				metaData.put("description", "Best list of newspapers and news sites in the world")
			metaData.put("image", "http://www.bddesh24.com/images/bddeshdefault/defaultLinkz.jpg")
			metaData.put("url", "http://www.bddesh24.com/newspapers/newsSourceList/"+newsSourceItem.id+"/"+seoCovert(title:newsSourceItem.title)+"-newspaper")
