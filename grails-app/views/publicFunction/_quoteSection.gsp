	...
	<div class="quoteLst">
		...
		<div class="tbx nbb cuqh">
			<div class="media">
				<div class="media-left">							    
				    <a href="<g:createLink uri="/profile/of/${quoteOwner.id}/${quoteOwner.username}"/>"><g:if test="${quoteOwner && quoteOwner.profileImage}">
						<img src="<g:createLink uri="/newsImages/d50/${quoteOwner.profileImage}"/>" class="media-object s40 rndImg">
					</g:if>
					<g:else>
						<g:if test="${quoteOwner && quoteOwner.gender}">
		...
		<div class="cbx">			
			<div class="brd3 qote qcc${k%10}">
				...
				<a href="<g:createLink uri="/quoteDay/author/${quote.quoteAuthor}"/>"><span class="qaut">${quote.quoteAuthorName}</span></a>
			</div>
