<g:each var="comnuser" in="${comments}">
	<g:set var="commentOwner" value="${comnuser[0]}"></g:set>
	<g:set var="comment" value="${comnuser[1]}"></g:set>
	<div class="mb5">
		<div class="ansBdr">
			<div class="media">
				...
				<div class="media-body">
					...
					<g:if test="${user && user.isAdmin && !comment.enabled}">
						<div class="aCmt">
							<a onclick="javascript:enableNSC(${comment.id},'ns')" href="javascript:void(0)">Enable</a>
						</div>
					</g:if>
				</div>
			</div>
