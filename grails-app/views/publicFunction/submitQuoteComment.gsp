			...
			<div class="media-body">
				...
				<div class="usrBox cmtBx">
		       		<div aria-label="button group" role="group" class="btn-group">					        			
		       			<a id="quCmtLike${newComment.id}" onclick="javascript:likeQuoteComment(${newComment.id})" role="button" class="btn btn-default" href="javascript:void(0)">
		       				<span aria-hidden="true" class="glyphicon glyphicon-thumbs-up"></span><span class="cmlld">${newComment.totalLike}</span>
		       			</a>		        			
		       		</div>
		       	</div>
			</div>
