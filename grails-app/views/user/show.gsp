			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="profileImage-label" class="property-label"><g:message code="user.profileImage.label" default="Profile Image" /></span>
						...
						<span class="property-value" aria-labelledby="profileImage-label"><g:fieldValue bean="${userInstance}" field="profileImage"/></span>
				...
				<li class="fieldcontain">
					<span id="profile-label" class="property-label"><g:message code="user.profile.label" default="Profile" /></span>
						...
						<span class="property-value" aria-labelledby="profile-label"><g:link controller="userProfile" action="show" id="${userInstance?.profile?.id}">${userInstance?.profile?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="gender-label" class="property-label"><g:message code="user.gender.label" default="Gender" /></span>
						...
						<span class="property-value" aria-labelledby="gender-label"><g:formatBoolean boolean="${userInstance?.gender}" /></span>
