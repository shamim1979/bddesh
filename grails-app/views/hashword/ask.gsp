...
<html>
	<head>
		<meta name="layout" content="questionHashWeb"/>
	</head>
	<body>
					...
					<div class="brd3 wbg mmt10">
						<div class="prel">
							<div id="profileCoverImage">
								<g:if test="${questionTag.coverImage}">
									<img src="<g:createLink uri="/newsImages/d690/${questionTag.coverImage}"/>" class="covphCen brd3">
								</g:if>
								<g:else>
							...
							<g:if test="${user && user.isAdmin}">
								<div class="abs pciUp text-center">
									<a class="ihbx" href="javascript:void(0)" onclick="javascript:addPhoto('hwask')">
							...
							<div class="abs hwTag">#${questionTag.questionTag}</div>
						</div>
					</div>
						...
						<g:if test="${user && user.isAdmin}">
							<div class="hwDes p5">									
								...
								<div class="sbmt">
									...
									<button id="hwDescriptionSubmitForm" onclick="javascript:submitHWDescription('hwask');" class="conbor sbbtn cmb0 lbtnw" type="button">Post</button>
								</div>
								<div style="clear: both;"></div>
					  		</div>
				  		</g:if>
				  		<g:if test="${questionTag.tagDescription}">
				  			<div class="cbx hwTtle"><h2>${questionTag.tagDescription}</h2></div>
				  		</g:if>
						<div class="cbx">
							<div id="hashFeedList">
				...
				<div class="col-sm-4 col-md-4 col-lg-4 cbpd">
					<div id="rightSec" class="mmt10">
						<div class="conbor wbg">
							...
							<g:render template="/home/popularQuestionHashword" model="[usaTags:usaTags,questionTags:questionTags,pollTags:pollTags,topTenTags:topTenTags,newsHashwords:newsHashwords,newsSourceTags:newsSourceTags]"></g:render>
					 	</div>
					</div>
				</div>
			</div>
