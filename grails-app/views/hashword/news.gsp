...
<html>
	<head>
		<meta name="layout" content="newsHashWeb"/>
	</head>
	<body>
					...
					<div class="brd3 wbg mmt10">
						<div class="prel">
							<div id="profileCoverImage">
								<g:if test="${articleHashWord.coverImage}">
									<img src="<g:createLink uri="/newsImages/d690/${articleHashWord.coverImage}"/>" class="covphCen brd3">
								</g:if>
								<g:else>
							...
							<g:if test="${user && user.isAdmin}">
								<div class="abs pciUp text-center">
									<a class="ihbx" href="javascript:void(0)" onclick="javascript:addPhoto('hwnews')">
							...
							<div class="abs hwTag">#${articleHashWord.hashWord}</div>
						</div>
					</div>
						...
						<g:if test="${user && user.isAdmin}">
							<div class="hwDes p5">									
								...
								<div class="sbmt">
									...
									<button id="hwDescriptionSubmitForm" onclick="javascript:submitHWDescription('hwnews');" class="conbor sbbtn cmb0 lbtnw" type="button">Post</button>
								</div>
								<div style="clear: both;"></div>
					  		</div>
				  		</g:if>
				  		<g:if test="${articleHashWord.hashWordTitle}">
				  			<div class="cbx hwTtle"><h2>${articleHashWord.hashWordTitle}</h2></div>
				  		</g:if>
						<div id="hashFeedList">
